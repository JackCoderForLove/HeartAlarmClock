...
-(instancetype)initWithUrl:(NSString *)url {
    ...
    if (self) {
        self.url = url;
        _progressViewColor = [UIColor colorWithHexString:@"47de69"];
    }
    return self;
}
...
-(void)initWKWebView
{
    ...
    //监控进度
    [_webView addObserver:self forKeyPath:@"estimatedProgress" options:NSKeyValueObservingOptionNew context:@"jcabcestimatedProgess"];
...
-(void)dealloc {
    @try {
        ...
        [self.webView removeObserver:self forKeyPath:@"estimatedProgress" context:@"jcabcestimatedProgess"];
        self.webView = nil;
